        ...
        <div class="col s12">
            <div class="row">
                <div class="input-field col s4">
                    ...
                    <input id="email" name="email" placeholder="maisablogueira@gmail.com" type="email" class="validate">
                ...
                <div class="input-field col s2">
                    <i class="material-icons prefix">streetview</i>
                    <input id="numero" name="numero" placeholder="69" type="text" class="validate">
                    <label for="numero">Nº</label>
                </div>
                    <div class="input-field col s3">
                        <i class="material-icons prefix">streetview</i>
                         <input id="bairro" name="bairro" placeholder="Jangurussu" type="text" class="validate">
                        <label>Bairro</label>
                </div>
            </div>
        </div>
